...
let clearUsuario = () => {                             
    webix.confirm({
        ...
        () => {
            ...
            $$("form_statusServicos").clear();               
            $$("form_statusServicos").clearValidation();     
        }
)};

let saveUsuario = () => {                                
    let form = $$( "form_statusServicos" );                      
    let list = $$( "table_statusServicos" );                     
    let item_data = $$("form_statusServicos").getValues();    
      ...
      $$("win_statusServicos").hide();                          
    }

var wTitulo = {
          "view": "label",
          "label": "Status Serviços",
          "id": "wTitulo",
          "height": 0
        };
...
const table_statusServicos = {                
    view:"datatable", 
    id:"table_statusServicos",
    scroll:"y",
    select:true,
    hover:"myhover",
    save:"/ts/testes/CrudTabelas/StatusSer_save.php",
...
const form_statusServicos = {                                   
    view:"form", 
    id:"form_statusServicos", 
	autowidth:true,
  borderless:true,
...
webix.ui({                                                        
  view:"window",
  id:"win_statusServicos",                                       
  width:300,

      modal:true,
  position:"center",
head:false,
  body:webix.copy(form_statusServicos)
});
...
function executa(wvar){
  ...
  wJson = chamaAJAX("/ts/testes/CrudTabelas/StatusSer_leitura.php");                         
  
  $$("table_statusServicos").clearAll();
  $$("table_statusServicos").parse(wJson.statusServico);                                                 
