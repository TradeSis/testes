<?php
  ...
  $fp = fopen('D:TRADESIS\ts\testes\CrudTabelas\StatusSer_save.txt', 'w'); 
...
fwrite($fp, $webix_operation."\n");
	...
	if($webix_operation=="update"){
        ...
        $sql = "UPDATE statusServico SET statusSer='$statusSer'";
    ...
    if($webix_operation=="insert"){                                          
        ...
        $sql  = "INSERT INTO `statusServico` ( `statusSer`)" ;
        $sql .= " VALUES ('$statusSer')";
