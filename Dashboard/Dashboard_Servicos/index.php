...
const table_tarefas = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save: "/ts/testes/Dashboard/Dashboard_Servicos/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
// alert ("periodo selecionado: " + wvar);
  wJson = chamaAJAX("/ts/testes/Dashboard/Dashboard_Servicos/leitura.php");                         //# 9- Modificação! NOVA****
