    ...
    vjsonBling3 = [];
     ...
     var ano = 0;
        ...
        for(i in JsonOriginal) {
                    ...
                    index = vjsonBling3.findIndex(x => x.ano == JsonOriginal[i].ano); 
                  // alert(index);

                    var vAno = parseFloat(JsonOriginal[i].ano);
                   // alert("ANO INICIAL!= "+JSON.stringify(vAno, null, 4));

                    var vano2019 = 0;
                    var vano2020 = 0;
                    var vano2021 = 0;

                   //alert("Mes="+JsonOriginal[i].mes+" Ano="+JsonOriginal[i].ano);

                    /*  if (JsonOriginal[i].ano=="2019") {
                                    vano2019 = vAno;    
                                   //alert("ANO 2019= "+vano2019);               
                                }

                    if (JsonOriginal[i].ano=="2020") {
                                    vano2020 = vAno;     
                                    //alert("ANO 2020= "+vano2020);              
                    }

                    if (JsonOriginal[i].ano=="2021") {
                            vano2021 = vAno;  
                                    //alert("ANO 2021= "+vano2021);
                    ...
                    if (index == -1 ) {
                              ...
                              vjsonBling3.push({//"mes": JsonOriginal[i].mes,
                                                "ano": JsonOriginal[i].ano,
                                               /*  "id": vano2019,
                                                "id": vano2020,
                                                "id": vano2021, */
                                                ...
                                                /* alert("NOVO ANO!= "+JSON.stringify(vano2019, null, 4));
                                                alert("NOVO ANO!= "+JSON.stringify(vano2020, null, 4));
                                                alert("NOVO ANO!= "+JSON.stringify(vano2021, null, 4)); 
                          */
                        } /* else {
                  
                                      vjsonBling3[index].id += vano2019; 
                                      vjsonBling3[index].id2 += vano2020; 
                                      vjsonBling3[index].id3 += vano2021; 
        ...
        //alert("NOVO JSON ANO!= "+JSON.stringify(vjsonBling3, null, 4));
        //alert(wTotal);
