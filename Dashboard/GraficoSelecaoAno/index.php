...
const table_vendas = {                 
    ...
    select:true,
    hover:"myhover",
    save: "/ts/testes/Dashboard/GraficoSelecaoAno/save.php",
...
webix.ready(function(){
     ...
     // alert(Xanos);
      ...
      carregaGraficoVendasPorMes(0, JsonEntrada);
...
function carregaJson(){
  wJson = chamaAJAX("/ts/testes/Dashboard/GraficoSelecaoAno/leitura.php"); 
  return wJson;
};
