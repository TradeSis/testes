  ...
  cols:[
    {
      ...
      gradient:"falling",
     // data: dataset
     series:[                      //DESCOBERTA - tooltip, responsavel por mostrar os valores quando passa o cursor!
      {
      value:"#vlrano1#",
      color:"#36abee",
      tooltip:{
...
const table_tarefas = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save: "/ts/testes/TiposdeGraficos/Barras3/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
// alert ("periodo selecionado: " + wvar);
  wJson = chamaAJAX("/ts/testes/TiposdeGraficos/Barras3/leitura.php");                         //# 9- Modificação! NOVA****
...
//*****************************************************************************************************************************************************!!! */
   ...
   alert("NOVO JSON= "+JSON.stringify(vjsonBling, null, 4));
