...
var wgrafico1 = ({
        ...
        // width:900,
          ...
          legend:{
            values:[{text:"2020",color:"#58dccd"},{text:"2021",color:"#a7ee70"},{text:"2022",color:"#36abee"}],
            valign:"middle",
            align:"right",
            width:90,
            layout:"y"
...
const table_tarefas = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save: "/ts/testes/TiposdeGraficos/Barras1.1/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
//JSON INICIAL VINDO DO BANCO DE DADOS - #1
  wJson = chamaAJAX("/ts/testes/TiposdeGraficos/Barras1.1/leitura.php");                         
...
//SE NÃO MANTEM OS VALORES DAS VARIAIS ANTERIORES. - #8        
                   ...
                   vjsonBling[index].vlrano2 += vvlrano2021; //
                   vjsonBling[index].vlrano3 += vvlrano2022; //
