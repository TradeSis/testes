...
var wTitulo = {
          "view": "label",
          "label": "Primeiro exemplo de Amostra, Hélio.",
          "id": "wTitulo",
          "height": 0
        };
...
wBotaoCarrega = { view:"uploader", value:"Load from Excel file", on:{
...
*/
json_columns = [
    {id:"field1", header:"FILIAL"},  {id:"field2",  header: "DATA_VENDA"},  {id:"field3", header: "PREVISAO_QTDE"},
    {id:"field4", header:"PREVISAO_VALOR (META LOJA)"},  {id:"field5",  header: "ESTOQUE"},  {id:"field6", header: "ESTOQUE_VALORIZADO"},
