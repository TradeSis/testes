...
const table_tarefas = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save:/* "/ts/erp/testes/crud/save.php" */  "/ts/testes/Crud_Add_Registros/Crud_Clientes/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
// alert ("periodo selecionado: " + wvar);
  wJson = chamaAJAX("/ts/testes/Crud_Add_Registros/Crud_Clientes/leitura.php");                         //# 9- Modificação! NOVA****
