...
const table_login = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save:/* "/ts/erp/testes/crud/save.php" */  "/ts/erp/testes/testesLucas/Crud_Add_Registros/Crud_Login/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
// alert ("periodo selecionado: " + wvar);
  wJson = chamaAJAX("/ts/erp/testes/testesLucas/Crud_Add_Registros/Crud_Login/leitura.php");                         //# 9- Modificação! NOVA****
