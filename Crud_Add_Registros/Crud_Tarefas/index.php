...
const table_tarefas = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save:/* "/ts/erp/testes/crud/save.php" */  "/ts/erp/testes/testesLucas/Crud_Add_Registros/Crud_Tarefas/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
// alert ("periodo selecionado: " + wvar);
  wJson = chamaAJAX("/ts/erp/testes/testesLucas/Crud_Add_Registros/Crud_Tarefas/leitura.php");                         //# 9- Modificação! NOVA****
